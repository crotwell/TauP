...
tasks.register<JavaExec>("genModels") {
  ...
  inputs.files("src/main/resources/edu/sc/seis/TauP/StdModels/ek137.tvel")
  ...
  inputs.files("src/main/resources/edu/sc/seis/TauP/StdModels/rem1d.nd")
  ...
  outputs.files(layout.buildDirectory.file(outDirStr+"/ek137.taup"))
    ...
    outputs.files(layout.buildDirectory.file(outDirStr+"/rem1d.taup"))
