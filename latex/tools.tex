...
additional phases will not be added to the header. Note that this does not refer to times that are already in the \textsc{sac} file before TauP\_SetSac is run. They will be overwritten. 
...
TauP\_SetSac will
overwrite any previously set \texttt{t} headers. A future feature may do
