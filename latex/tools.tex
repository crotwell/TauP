...
TauP\_VelocityMerge overlays a partial velocity model over the given base velocity model.
...
-mergend modelfile       -- "named discontinuities" velocity file to merge
-mergetvel modelfile     -- ".tvel" velocity file to merge, ala ttimes
