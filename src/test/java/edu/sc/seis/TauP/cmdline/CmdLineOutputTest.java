...
public class CmdLineOutputTest {
    ...
    public void regenReflTranCompareFigures() throws Exception {
        ...
        fmgsFigureTestCmds.put("FMGS_fig_13_12a.svg",
                "taup refltrans -o stdout --abs --pwave --layer 8.0 4.6 3.3 6.4 3.7 2.8 -x rayparam --legend --svg");
        ...
        fmgsFigureTestCmds.put("FMGS_fig_13_12b.svg",
                "taup refltrans -o stdout --abs --swave --layer 8.0 4.6 3.3 6.4 3.7 2.8 -x rayparam --yminmax -0.05 1.3 --legend --svg");
        ...
        fmgsFigureTestCmds.put("FMGS_fig_13_13a.svg",
                "taup refltrans -o stdout --abs --pwave --layer 6.4 3.7 2.8 8.0 4.6 3.3 -x rayparam --yminmax 0 2 --legend --svg");
        ...
        fmgsFigureTestCmds.put("FMGS_fig_13_13b.svg",
                "taup refltrans -o stdout --abs --swave --layer 6.4 3.7 2.8 8.0 4.6 3.3 -x rayparam --yminmax 0 2 --legend --svg");
        ...
        fmgsFigureTestCmds.put("FMGS_fig_13_11a.svg",
                "taup refltrans -o stdout --abs --shwave --layer 6.4 3.7 2.8 8.0 4.6 3.3 --down -x rayparam --yminmax 0 2 --legend --svg");
        figureTitles.put("FMGS_fig_13_11a.svg", "FMGS, fig 13.11a, solid-solid Sh");
        figureCompare.put("FMGS_fig_13_11a.svg", "FMGS_fig_13_11a.png");

        fmgsFigureTestCmds.put("FMGS_fig_13_11b.svg",
                "taup refltrans -o stdout --shwave --layer 6.4 3.7 2.8 8.0 4.6 3.3 --up -x rayparam --yminmax -1.05 1.4 --legend --svg");
        figureTitles.put("FMGS_fig_13_11b.svg", "FMGS, fig 13.11b, solid-solid Sh");
        figureCompare.put("FMGS_fig_13_11b.svg", "FMGS_fig_13_11b.png");

        fmgsFigureTestCmds.put("FMGS_fig_13_14a.svg",
                "taup refltrans -o stdout --abs --pwave --layer 5.8 3.35 2.5 0.3 0 1.2 -x rayparam --yminmax 0 2.5 --legend --svg");
        ...
        fmgsFigureTestCmds.put("FMGS_fig_13_14b.svg",
                "taup refltrans -o stdout --abs --swave --layer 5.8 3.35 2.5 0.3 0 1.2 -x rayparam -y Rss Rsp Tsp --legend --svg");
        ...
        fmgsFigureTestCmds.put("AR_fig_5_10.svg",
                "taup refltrans -o stdout --abs --swave --layer 5 3 2.5 0 0 0 -x rayparam  -y Rsp Rss --legend --svg");
    ...
    public void loadTest() throws Exception {
        ...
        String shouldBeS = "> seg 1/2 P of P at   411.69 seconds at    35.00 degrees for a     10.0 km deep source in the prem model with rayParam    8.604 s/deg. in crust/mantle from 0.00 deg, 10.0 km to 17.48 deg, 848.0 km";
