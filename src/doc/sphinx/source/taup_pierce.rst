...
.. literalinclude:: examples/taup_pierce_--mod_prem_-h_200_-p_S_--sta_12_34.2_--evt_-28_122_--geodist_geodetic_--pierce_2591_--nodiscon.cmd
  :language: text
...
Using the :code:`--geodist geodetic` or :code:`--geodist geocentric`
is useful for the distance calculation with latitudes and longitudes.
Here is the output,
distance, depth, latitude and longitude, respectively.

.. literalinclude:: examples/taup_pierce_--mod_prem_-h_200_-p_S_--sta_12_34.2_--evt_-28_122_--geodist_geodetic_--pierce_2591_--nodiscon
  :language: text
