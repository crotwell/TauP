...
This can be used to create the familiar travel time curves, but for
...
The :code:`-gmt` option will prepend a GMT :code:`psxy` command to the output
...
Other parameters besides distance vs time can be plotted using the `-x`
...
Note that these images are intended to be a quick, basic view into the results,
